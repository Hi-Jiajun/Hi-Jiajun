...
<div align="center">
  ...
  <p>
    🛠️ 我把 GitHub 当成公开工作台，放一些自己做的小工具、脚本、实验项目，也放一些我会学习、适配和参考的 fork。<br/>
...
| --- | --- | --- |
| [CN-Domain-Rule-Auto-Generator](https://github.com/Hi-Jiajun/CN-Domain-Rule-Auto-Generator) | Automated generation pipeline for China mainland direct-connect domain rules<br/>中国大陆直连域名规则的自动生成流程 | Python · ⭐ 2 · updated 2026-04-18 |
...
| [pua](https://github.com/Hi-Jiajun/pua) | Fork for studying and adapting agent execution patterns<br/>用于研究和适配 Agent 执行模式的 fork | TypeScript · ⭐ 0 · updated 2026-03-31 |
...
| Repository | Status |
| --- | --- |
| [CN-Domain-Rule-Auto-Generator](https://github.com/Hi-Jiajun/CN-Domain-Rule-Auto-Generator) | 🛠️ Original · Automated generation pipeline for China mainland direct-connect domain rules<br/>中国大陆直连域名规则的自动生成流程<br/>updated 2026-04-18 |
| [vpp-pppoeclient](https://github.com/Hi-Jiajun/vpp-pppoeclient) | 🛠️ Original · Standalone repository for a VPP PPPoE client plugin extracted from my branch work<br/>从我的分支工作中拆出的 VPP PPPoE Client 独立仓库<br/>updated 2026-04-04 |
| [pua](https://github.com/Hi-Jiajun/pua) | 🍴 Fork · Fork for studying and adapting agent execution patterns<br/>用于研究和适配 Agent 执行模式的 fork<br/>updated 2026-03-31 |
...
<p>
  <img src="https://img.shields.io/badge/Python-Tooling-3776AB?style=flat-square" alt="Python" />
  <img src="https://img.shields.io/badge/Node.js-Scripts-339933?style=flat-square" alt="Node.js" />
...
<p align="center">
  <img src="./assets/generated/profile-snapshot.png?v=59c7a786cb66" alt="Auto-generated GitHub snapshot for Hi-Jiajun" />
</p>
